...
<body>
        ...
        <div class="page1">
                ...
                <div class="nav-links">
                    <ul>
                        ...
                        <div class="profiledp">
                            ...
                            <i class="fa-solid fa-user" id="profile1" style="color: #ecf0f3;"></i>
                            <p>Account <i class="fa-solid fa-angle-down" style="color: #fcfcfd;"></i></p>
                            
                        </div>
                        <button onclick="window.location.href='index.php'" id="logout">Log Out</button>
                    </ul>
                </div>
                <!-- <button onclick="window.location.href='signup.php'">Login</button> -->
                <!-- <img src="profile.webp" alt="" width="auto" height="40px" id="profile"> -->
                <i class="fa-solid fa-user" id="profile" style="color: #ecf0f3;"></i>
                <div id="userinfo">
                    <p id=para1>Account</p>
                    <p id="para2">Hello, <?php echo $username; ?></p>
            ...
            <div class="videofootage">
                ...
                <div class="textupper">
                    ...
                    <button id="Btn1" onclick="window.location.href='gemini.php'">
                        Chat with Gemini
                        <span class="arrow">
        ...
        <div class="page2">
            ...
            <div class="grid-container">
                ...
                <div class="heading1">
                    ...
                    <button class="Btn" onclick="window.location.href='gemini.php'">
                        Chat with Gemini
                        <span class="arrow">
                            <i class="fa-solid fa-arrow-right"></i></span>
                    </button>
        ...
        <div class="conform">
            ...
            <div class="contact" id="contact">
                <form action="https://api.web3forms.com/submit" method="POST" class="contact-left" id="myform">
                    ...
                    <input type="email" name="email" id="email" placeholder="What's your web address?"
    ...
    <script>
        ...
        const proToggle = document.getElementById("profile");
        const userinfo = document.getElementById("userinfo");

        proToggle.addEventListener("click", () => {
            userinfo.classList.toggle("activate");
        });
